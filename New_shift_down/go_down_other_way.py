...
pattern = []
p = 256
puzzle = 68688343161474140794844335318204114708838568864707193499454640156520632917638
print(f'Puzzle: {puzzle}')
act1 = pows[p] - puzzle
print(f'{pows[p]} - {puzzle} = {act1}')
counter = 0
while p > 0:
    while pows[p] > act1:
        p = p - 1
    ...
    act1 = pows[p] - save
    counter += 1
    print(f'{counter}: {pows[p]} - {save} = {act1} power=[{p}]')
    if act1 == 0 or act1 == 1:
        break
'''
while p > 0:
