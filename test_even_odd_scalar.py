pows = [2**1,2**2,2**3,2**4,2**5,2**6,2**7,2**8,2**9,
...
bits = 10
puzzle = 1788
puzzle_minus_two = puzzle - 2
puzzle_div = puzzle // 2
num_set = list()
num_set.append(puzzle_div)
print(f'{puzzle} : {2} = {puzzle_div}')
for i in range(bits - 2):
    puzzle_div += pows[i]
    num_set.append(puzzle_div)
    print(f'{pows[i]} {puzzle_div}')
     
print(num_set)
print()
res1 = puzzle_minus_two - num_set[-2]
res2 = puzzle - num_set[-1]
dbl_res1 = res1 * 2
dbl_res1_min_res2 = dbl_res1 - res2
print(f'{puzzle_minus_two} - {num_set[-2]} = {res1}')
print(f'{puzzle} - {num_set[-1]} = {res2}')
print(f'{res1} * 2 = {dbl_res1}')
print(f'{dbl_res1} - {res2} = {dbl_res1_min_res2}')
